var f="1.0.0";var x={get definitionVersion(){return f},get resourceType(){return"APP"},get info(){return{get author(){return"saharan"},get org(){return"lv"}}}};var cr=({registerCsses:e},n)=>{e&&e(`
  :host li{
    display:block;
    line-height:1.5;
    font-size:14px;
